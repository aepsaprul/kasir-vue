            ...
            <CCol :md="12">
                <CCard class="mb-4">
                    <CCardHeader class="d-flex justify-content-between align-items-center">
                        ...
                        <CButton color="primary" size="sm" @click="openModal"><CIcon icon="cil-plus" height="15"></CIcon> Tambah Pelanggan</CButton>
                    </CCardHeader>
                </CCard>
                ...
                <div v-else class="d-flex flex-column gap-1">
                    <CCard v-for="item in items" :key="item.id" class="shadow-sm">
                        <CCardBody>
                            ...
                            <!-- No Telepon -->
                            <div class="text-muted small mb-1"><CIcon icon="cil-phone" height="15"></CIcon> {{ item.phone || '-' }}</div>
                            <!-- Alamat -->
